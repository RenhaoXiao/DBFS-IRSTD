...
| Dataset | Model | Params (M) | GFLOPs | AP50:95 | AR50:95 | Pd@0.75 |
|---------|-------|-----------:|-------:|---------:|---------:|---------:|
| IRSTD-1k | DEIMv2_atto | **0.48** | **1.80** | 0.316 | 0.546 | 0.468 |
| IRSTD-1k | Ours | 0.52 | 1.88 | **0.433** | **0.557** | **0.542** |
| NUDT-SIRST | DEIMv2_atto | **0.48** | **1.80** | 0.646 | 0.711 | 0.767 |
| NUDT-SIRST | Ours | 0.52 | 1.88 | **0.702** | **0.766** | **0.872** |
