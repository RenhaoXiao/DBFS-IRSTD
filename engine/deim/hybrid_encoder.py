...
class RepNCSPELAN4(nn.Module):
    ...
    def __init__(self, c1, c2, c3, c4, n=3,
        ...
        if csp_type == 'csp2':
            ...
            CSP_Node = globals().get('CSPLayer', CSPLayer2) 

        self.cv2 = nn.Sequential(CSP_Node(c3//2, c4, n, 1, bias=bias, act=act, bottletype=VGGBlock), ConvNormLayer_fuse(c4, c4, 3, 1, bias=bias, act=act))
        self.cv3 = nn.Sequential(CSP_Node(c4, c4, n, 1, bias=bias, act=act, bottletype=VGGBlock), ConvNormLayer_fuse(c4, c4, 3, 1, bias=bias, act=act))
